...
MP3DOWNLOADER.prototype.download = function(videoID){
    ...
    request('https://www.googleapis.com/youtube/v3/videos?part=id%2C+snippet&id=' + videoID + '&key=AIzaSyC-eBlpk6ksj-x9KWdje0nVHBue-U-T5_k',
        ...
        ytdl.getInfo(youtubeFullUrl, function(error, info){
            ...
            if (error) {
                ...
                downloadedVideo.on("response", function(){
                    ...
                    .on("end", function(){
                        //return videoInfo;
                        console.log("Done downloading, here is info about it: ");
...
//let testFunction = new MP3DOWNLOADER({"fileSavePath": "C:/Users/davos/Music/youtubetomp3test/", "ffmpegPath": "C:/ffmpeg/bin/ffmpeg"});

//testFunction.download('zyXmsVwZqX4');
